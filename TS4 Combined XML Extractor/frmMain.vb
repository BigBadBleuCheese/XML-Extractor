...
Public Class frmMain
    ...
    Private Const V As Integer = 101
    Private Const V1 As Integer = V + 1
    Private Const V2 As Integer = V + V1
    ...
    Private Sub PerformFullAutoExtract(gameFolderPath As String, outputFolderPath As String)
        ...
        Dim memStreams(V2) As MemoryStream
        ...
        For I = 0 To V
            ...
            If memStreams(I) IsNot Nothing Then
                ...
                memStreams(V1 + I) = New MemoryStream
                BinThreadQueue.Enqueue(New clsBinaryTuningConvertorThread(Me, memStreams(I), memStreams(V1 + I), cbIncludeStrings.Checked, cbIncludeXmlNames.Checked, stblCombined, XmlNameTable))
                NumLeft += 1
                My.Application.DoEvents()
            End If
        Next
        ...
        For I = V1 To V2
            My.Application.DoEvents()
            If memStreams(I) IsNot Nothing Then
                GamePackNumber = GetGamePackNumber(I - V1)
